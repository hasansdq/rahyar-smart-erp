...
import { UIProvider } from './context/UIContext'; // Import Provider
...
const App = () => {
  ...
  if (!user) {
      // Login screen doesn't need global UI provider for toasts necessarily, but we can wrap it if we want registration toasts.
      // For now, LoginScreen uses local error state which is fine.
